...
CORBA::Long HelloWorld_stub::getDistance()
{
  CORBA::Long _res;
  CORBA::StaticAny __res( CORBA::_stc_long, &_res );

  CORBA::StaticRequest __req( this, "getDistance" );
  __req.set_result( &__res );
...
CORBA::Long
HelloWorld_stub_clp::getDistance()
{
  PortableServer::Servant _serv = _preinvoke ();
  if (_serv) {
    POA_HelloWorld * _myserv = POA_HelloWorld::_narrow (_serv);
  ...
  return HelloWorld_stub::getDistance();
}

#endif // MICO_CONF_NO_POA

CORBA::Long HelloWorld_stub::getBigrock()
{
  CORBA::Long _res;
  CORBA::StaticAny __res( CORBA::_stc_long, &_res );

  CORBA::StaticRequest __req( this, "getBigrock" );
  __req.set_result( &__res );
...
CORBA::Long
HelloWorld_stub_clp::getBigrock()
{
  PortableServer::Servant _serv = _preinvoke ();
  if (_serv) {
    POA_HelloWorld * _myserv = POA_HelloWorld::_narrow (_serv);
  ...
  return HelloWorld_stub::getBigrock();
}

#endif // MICO_CONF_NO_POA

CORBA::Long HelloWorld_stub::getDeepsand()
{
  CORBA::Long _res;
  CORBA::StaticAny __res( CORBA::_stc_long, &_res );

  CORBA::StaticRequest __req( this, "getDeepsand" );
  __req.set_result( &__res );
...
CORBA::Long
HelloWorld_stub_clp::getDeepsand()
{
  PortableServer::Servant _serv = _preinvoke ();
  if (_serv) {
    POA_HelloWorld * _myserv = POA_HelloWorld::_narrow (_serv);
  ...
  return HelloWorld_stub::getDeepsand();
}

#endif // MICO_CONF_NO_POA

CORBA::Long HelloWorld_stub::getmo()
{
  CORBA::Long _res;
  CORBA::StaticAny __res( CORBA::_stc_long, &_res );

  CORBA::StaticRequest __req( this, "getmo" );
  __req.set_result( &__res );
...
HelloWorld_stub_clp::getmo()
{
  ...
  return HelloWorld_stub::getmo();
}

#endif // MICO_CONF_NO_POA

struct __tc_init_MARS {
  __tc_init_MARS()
  {
...
static __tc_init_MARS __init_MARS;
...
POA_HelloWorld::dispatch (CORBA::StaticServerRequest_ptr __req)
{
  ...
  try {
    ...
    case 0:
      if( strcmp( __req->op_name(), "getDeepsand" ) == 0 ) {
        CORBA::Long _res;
        CORBA::StaticAny __res( CORBA::_stc_long, &_res );
        __req->set_result( &__res );
    ...
    case 2:
      ...
      break;
    case 3:
      if( strcmp( __req->op_name(), "getmo" ) == 0 ) {
        CORBA::Long _res;
        CORBA::StaticAny __res( CORBA::_stc_long, &_res );
        __req->set_result( &__res );
      ...
      break;
    case 7:
      if( strcmp( __req->op_name(), "getBigrock" ) == 0 ) {
        CORBA::Long _res;
        CORBA::StaticAny __res( CORBA::_stc_long, &_res );
        __req->set_result( &__res );
    ...
    case 8:
      ...
      break;
    case 9:
      if( strcmp( __req->op_name(), "getDistance" ) == 0 ) {
        CORBA::Long _res;
        CORBA::StaticAny __res( CORBA::_stc_long, &_res );
        __req->set_result( &__res );
